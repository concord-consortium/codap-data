var map = {
  Markov: {
    title: 'Markov',
    description: "Play Roshambo against the evil Dr. Markov. If you win, you can save Madeline the dog. Improve you odds by analyzing Markov's moves in a graph.",
  ...
  Scie_Bio_Midges: {
    title: 'Midges',
    description: 'What are the differences between two varieties of midges?',
  ...
  Scie_ESci_Iowa: {
    title: 'Iowa Weather',
    description: 'Explore weather information about Marion, Iowa.',
  ...
  SocSci_CA_Crime_Canada: {
    ...
    path: 'FathomDocs/Social_Science/Canada/Crime_Canada/Crime_Canada.json',
    ready: false,
    categories: ['canada']
  },
  SocSci_CA_Ontario_Census: {
    title: "Ontario Census",
    description: 'Explore data about the population of Ontario, Canada in 2001.',
    path: 'FathomDocs/Social_Science/Canada/Ontario_Census/Ontario_Census.json',
    ready: true,
    categories: ['canada']
  },
  SocSci_CA_Ontario_Lang: {
    title: "Languages of Ontario",
    description: 'Explore data about the languages spoken in Ontario.',
    path: 'FathomDocs/Social_Science/Canada/Ontario_Lang/Ontario_Lang.json',
    ready: true,
    categories: ['canada']
  },
  SocSci_CA_SmokingEd: {
    title: "Smoking and Education",
    description: 'Find relationships between the smokers and their education levels in Canada.',
    path: 'FathomDocs/Social_Science/Canada/SmokingEd/SmokingEd.json',
    ready: true,
    categories: ['canada']
  },
  SocSci_CA_Tech_Use: {
    title: "Technology Use in Canada",
    description: 'A case table about the Canadian technology use in 2001.',
    path: 'FathomDocs/Social_Science/Canada/Tech_Use/Tech_Use.json',
    ready: true,
    categories: ['canada']
  },
  SocSci_CA_Wheat1908: {
    title: "Wheat Production Since 1908",
    description: 'A case table about wheat production in provinces around Canada since 1908.',
    path: 'FathomDocs/Social_Science/Canada/Wheat1908/Wheat1908',
    ready: true,
    categories: ['canada']
  },
  SocSci_CA_Youth_Crimes: {
    title: "Youth Crimes",
    description: 'A case table contains information about the number of youth crimes in Canada from 1983 to 1999.',
    path: 'FathomDocs/Social_Science/Canada/Youth_Crimes/Youth_Crimes.json',
    ready: true,
    categories: ['canada']
  },
  SocSci_CA_YouthSurvey: {
    title: "Youth Survey",
    description: 'A case table with data from the Ontario Youth survey conducted between 1994 and 1999.',
    path: 'FathomDocs/Social_Science/Canada/YouthSurvey/YouthSurvey',
    ready: true,
    categories: ['canada']
  },
  SocSci_Euro_French_Franc: {
    title: "French Franc Over Time",
    description: 'Explore the fluctuation of the value of the French Franc over time.',
    path: 'FathomDocs/Social_Science/Europe/French_Franc/French_Franc.json',
    ready: true,
    categories: ['europe']
  },
  SocSci_Euro_German_Trade: {
    title: "German Foreign Trade",
    description: 'A case table about German foreign trade over time.',
    path: 'FathomDocs/Social_Science/Europe/German_Trade/German_Trade.json',
    ready: true,
    categories: ['europe']
  },
  SocSci_Euro_Potato_Migration: {
    title: "Migration During the Potato Famine",
    description: 'Data on migration from Great Britain and Ireland to the US from the years 1820 to 1870.',
    path: 'FathomDocs/Social_Science/Europe/Potato_Migration/Potato_Migration.json',
    ready: true,
    categories: ['europe']
  },
  SocSci_Euro_Russian_Cities: {
    title: "Russian City Populations",
    description: 'A case table with information about the population of capitol cities and cities of 100,000 and more inhabitants in the Russian Federation in 1999.',
    path: 'FathomDocs/Social_Science/Europe/Russian_Cities/Russian_Cities.json',
    ready: true,
    categories: ['europe']
  },
  ...
  SocSci_Euro_UK_Smoking: {
    title: "UK Smoking",
    description: 'A case table about the smoking habits of people in the United Kingdom.',
    path: 'FathomDocs/Social_Science/Europe/UK_Smoking/UK_Smoking.json',
    ready: true,
    categories: ['europe']
  },
  SocSci_LAmerica_Brazil: {
    title: "Cities of Brazil",
    description: 'Explore the populations of capitol cities and cities of 100,000 and more inhabitants in Brazil in the year 2000.',
    path: 'FathomDocs/Social_Science/Latin_America/Brazil/Brazil.json',
    ready: true,
    categories: ['latin_america']
  },
  SocSci_LAmerica_CR_Exchange: {
    title: "Costa Rica Exchange Rates",
    description: 'A case table about the exchange rates for the Costa rican Colón with respect to US Dollar.',
    path: 'FathomDocs/Social_Science/Latin_America/CR_Exchange/CR_Exchange.json',
    ready: true,
    categories: ['latin_america']
  },
  SocSci_LAmerica_CRPop: {
    title: "Costa Rica Population",
    description: 'A case table about the population of Costa Rica since 1522.',
    path: 'FathomDocs/Social_Science/Latin_America/CRPop/CRPop.json',
    ready: true,
    categories: ['latin_america']
  },
  SocSci_LAmerica_PeruPop: {
    title: "Peru Population",
    description: 'A case table about the population of Peru.',
    path: 'FathomDocs/Social_Science/Latin_America/PeruPop/PeruPop',
    ready: true,
    categories: ['latin_america']
  },
  SocSci_US_CA_Counties: {
    title: "CA Counties",
    description: 'The 2000 school year projections for each county in California',
    path: 'FathomDocs/Social_Science/United_States/CA_Counties/CA_Counties.json',
    ready: true,
    categories: ['united_states']
  },
  SocSci_US_Cars07: {
    title: "Cars",
    description: 'A case table about random passenger car models from 1993',
    path: 'FathomDocs/Social_Science/United_States/Cars07/Cars07.json',
    ready: true,
    categories: ['united_states']
  },
  SocSci_US_Cemetery: {
    title: "St. Augustine's Cemetery",
    description: 'A collection of data about the St. Augustine Catholic Cemetery.',
    path: 'FathomDocs/Social_Science/United_States/Cemetery/Cemetery.json',
    ready: true,
    categories: ['united_states']
  },
  SocSci_US_Starlight: {
    title: "Coast Starlight",
    description: 'The Coast Starlight Amtrak train schedule.',
    path: 'FathomDocs/Social_Science/United_States/Starlight/Starlight.json',
    ready: true,
    categories: ['united_states']
  },
  SocSci_US_Counties: {
    title: "Continental US Counties",
    description: 'Explore data from the 2004 presidential election.',
    path: 'FathomDocs/Social_Science/United_States/Counties/Counties.json',
    ready: true,
    categories: ['united_states']
  },
  SocSci_US_CPI_By_Month: {
    title: "CPI By Month",
    description: 'Data on the CPI for each month from 1913 to 2004 in the United States.',
    path: 'FathomDocs/Social_Science/United_States/CPI_By_Month/CPI_By_Month.json',
    ready: true,
    categories: ['united_states']
  },
  SocSci_US_CPI_By_Year: {
    title: "CPI By Year",
    description: 'Data on the CPI for each year from 1913 to 2011 in the United States.',
    path: 'FathomDocs/Social_Science/United_States/CPI_By_Year/CPI_By_Year.json',
    ready: true,
    categories: ['united_states']
  },
  ...
  SocSci_US_States_Apportionment: {
    title: "States - Apportionment",
    description: 'A case table about the proportion of state representatives to the population of each state.',
    path: 'FathomDocs/Social_Science/United_States/States/Apportionment/Apportionment.json',
    ready: true,
    categories: ['united_states','states']
  },
  SocSci_US_States_CarsNDrivers: {
    title: "States - Cars and Drivers",
    description: 'A case table about the number of cars, drivers, and roads in the United States.',
    path: 'FathomDocs/Social_Science/United_States/States/CarsNDrivers/CarsNDrivers.json',
    ready: true,
    categories: ['united_states','states']
  },
  SocSci_US_States_Ethnicity: {
    title: "States - Ethnicity",
    description: 'A case table about ethnicity in each of the United States.',
    path: 'FathomDocs/Social_Science/United_States/States/Ethnicity/Ethnicity.json',
    ready: true,
    categories: ['united_states','states']
  },
  SocSci_US_States_GetToWork: {
    title: "States - Getting To Work",
    description: 'A case about the way people got to work in 1989 in the United States.',
    path: "FathomDocs/Social_Science/United_States/States/GetToWork/GetToWork.json",
    ready: true,
    categories: ['united_states','states']
  },
  SocSci_US_States_Map: {
    title: "States - Map",
    description: 'A case table about the population of the United States.',
    path: 'FathomDocs/Social_Science/United_States/States/Map/Map.json',
    ready: true,
    categories: ['united_states','states']
  },
  SocSci_US_States_PhonesNRentals: {
    title: "States - Phones and Rentals",
    description: 'A case table about the number of occupied housing units from the 1990 United States Census.',
    path: 'FathomDocs/Social_Science/United_States/States/PhonesNRentals/PhonesNRentals.json',
    ready: true,
    categories: ['united_states','states']
  },
  SocSci_US_States_SAT: {
    title: "States - SAT",
    description: 'A case table about the SAT score averages by state from 1987-88 to 2001-02.',
    path: 'FathomDocs/Social_Science/United_States/States/SAT/SAT.json',
    ready: true,
    categories: ['united_states','states']
  },
  SocSci_US_States_SeatBelts: {
    title: "States - Seat Belts",
    description: 'A case table about seat belt usage in the United States.',
    path: 'FathomDocs/Social_Science/United_States/States/SeatBelts/SeatBelts.json',
    ready: true,
    categories: ['united_states','states']
  },
  SocSci_US_States_Sewers: {
    title: "States - Sewers",
    description: 'A case table about sewer systems used by houses in the United States.',
    path: 'FathomDocs/Social_Science/United_States/States/Sewers/Sewers.json',
    ready: true,
    categories: ['united_states','states']
  },
  SocSci_US_States_Taxes: {
    title: "States - Taxes",
    description: 'A case table about the amounts of taxes collected in each of the United States.',
    path: 'FathomDocs/Social_Science/United_States/States/Taxes/Taxes.json',
    ready: true,
    categories: ['united_states','states']
  },
  SocSci_US_States_Traffic: {
    title: "States - Traffic",
    description: 'A case table about traffic statistics in each of the United States.',
    path: 'FathomDocs/Social_Science/United_States/States/Traffic/Traffic.json',
    ready: true,
    categories: ['united_states','states']
  },
  SocSci_US_States_UrbanNRuralPop: {
    title: "States - Urban and Rural Population",
    description: 'A case table about the urban and rural populations of the United States',
    path: 'FathomDocs/Social_Science/United_States/States/UrbanNRuralPop/UrbanNRuralPop.json',
    ready: true,
    categories: ['united_states','states']
  },
  SocSci_US_States_Women: {
    title: "States - Women",
    description: 'A case table about women around the United States in 1998',
    path: 'FathomDocs/Social_Science/United_States/States/Women/Women.json',
    ready: true,
    categories: ['united_states','states']
  },
  SocSci_US_Census_CA_1990: {
    title: "CA Census 1880-1990",
    description: 'Data from the United States Census from 1880 to 1990',
    path: 'FathomDocs/Social_Science/United_States/US_Census/CA_2000/CA_2000.json',
    ready: true,
    categories: ['united_states','census']
  },
  SocSci_US_Census_CA_2000: {
    title: "CA Census 2000, including Berkeley",
    description: 'Data from the United States Census from 2000, including Berkeley',
    path: 'FathomDocs/Social_Science/United_States/US_Census/CA_2000/CA_2000.json',
    ready: true,
    categories: ['united_states','census']
  },
  SocSci_US_Census_DC: {
    title: "US Census - DC",
    description: 'Data from the District of Columbia Census.',
    path: 'FathomDocs/Social_Science/United_States/US_Census/DC/DC.json',
    ready: true,
    categories: ['united_states','census']
  },
  SocSci_US_Census_MA_1990: {
    title: "US Census - Massachusetts 1910 and 1990",
    description: 'Data from the censuses of 1910 and 1990 in Massachusetts.',
    path: 'FathomDocs/Social_Science/United_States/US_Census/MA_1990/MA_1990',
    ready: true,
    categories: ['united_states','census']
  },
  SocSci_US_Census_Miami: {
    title: "US Census - Miami,Florida",
    description: 'Data from the PUMA Census, part 3901.',
    path: 'FathomDocs/Social_Science/United_States/US_Census/Miami/Miami.json',
    ready: true,
    categories: ['united_states','census']
  },
  SocSci_US_Census_NYC_5206: {
    title: "US Census - NY City 5206",
    description: 'Data from an IPUMS Census from the University of Minnesota.',
    path: 'FathomDocs/Social_Science/United_States/US_Census/NYC_5206/NYC_5206.json',
    ready: true,
    categories: ['united_states','census']
  },
  SocSci_US_Census_NYC_5507: {
    title: "US Census - NY City 5507",
    description: 'Data from an IPUMS Census from the University of Minnesota.',
    path: 'FathomDocs/Social_Science/United_States/US_Census/NYC_5507/NYC_5507.json',
    ready: true,
    categories: ['united_states','census']
  },
  SocSci_US_Census_Ohio: {
    title: "US Census - Ohio South",
    description: 'Data from an IPUMS Census from the University of Minnesota.',
    path: 'FathomDocs/Social_Science/United_States/US_Census/Ohio/Ohio.json',
    ready: true,
    categories: ['united_states', 'census']
  },
  SocSci_US_Census_VA_Arlington: {
    title: "US Census - VA Arlington County",
    description: "Data from an IPUMS Census from the University of Minnesota.",
